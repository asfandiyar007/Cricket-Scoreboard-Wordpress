...
<strong><p>✅ Live Cricket Score Plugin Shortcode &rArr; <code>[hellocricket1]</code></p></strong> 
...
<strong><p>Enter 2nd Live Match URL 🍔</p></strong>
<input type="text" name="hellocric_match_url1" class="regular-text" value="<?php echo get_option('hellocric_match_url1'); ?>" />
...
<strong><p>Background Color 2 🍔</p></strong>
<input type="text" name="hellocri_bg_color1" class="hellocri-color-field" data-default-color="#7158e2" value="<?php echo get_option('hellocri_bg_color1'); ?>" />
